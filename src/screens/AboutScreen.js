...
function AboutScreen() {
    ...
    <div className="container aboutus">
        <div className="row">
            ...
            <div className="col-md-6 col-12 my-auto">
                <h1 className="display-4 text-center my-5 tt">About Us </h1>
        ...
        <div className="about_company">
            <h1 className="display-4 tt">About Company</h1>
            <div className="pt-4">
        ...
        <div className="testimony">
            <h1 className="display-4 mb-4 tt">What Our Clients says</h1>
                    ...
                    <div id="carouselExampleCaptions" className="carousel slide" data-ride="carousel">
                        ...
                        <div className="carousel-inner card border-0 shadow-lg p-4">
                            <div className="carousel-item active text-center">
                                <div className="row">
                                    <div className="col-md-8 col-12 my-auto">
                                        <img src={require('../images/customers/customer.PNG')} className="text-center img-fluid" width="450" height="400" alt="customer1" />
                                    </div>
                            ...
                            <div className="carousel-item text-center">
                                <div className="row">
                                    <div className="col-md-8 col-12 my-auto">
                                        <img src={require('../images/customers/customer1.PNG')} className="text-center img-fluid" width="450" height="400" alt="customer2" />
                                    </div>
                                    <div className="col-md-4 col-12 my-auto">
                                        <div className="text-dark">
                            ...
                            <div className="carousel-item text-center">
                                <div className="row">
                                    <div className="col-md-8 col-12 my-auto">
                                        <img src={require('../images/customers/customer2.PNG')} className="text-center img-fluid" width="450" height="400" alt="customer3" />
                                    </div>
                                    <div className="col-md-4 col-12 my-auto">
                                        <div className="text-dark">
                            ...
                            <div className="carousel-item text-center">
                                <div className="row">
                                    <div className="col-md-8 col-12 my-auto">
                                        <img src={require('../images/customers/customer2.PNG')} className="text-center img-fluid" width="450" height="400" alt="customer4" />
                                    </div>
                                    <div className="col-md-4 col-12 my-auto">
                                        <div className="text-dark">
                                            <h3 className="font-weight-bolder ">Customer RTY</h3>
        ...
        <div className="team">
            <h1 className="display-4 tt">Our Team</h1>
        </div>
        <div className="row mb-5">
